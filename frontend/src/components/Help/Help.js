const Help = () => {
  return (
    <ul className='list-disc pl-4 text-base text-gray-500 dark:text-gray-300 mt-3'>
      ...
      <img
        ...
        alt='First Example'
      />
      <p className='text-left text-base ml-1'>
      ...
      <img
        ...
        alt='Third'
      />
      <p className='text-left text-base ml-1'>No letters are found in the word</p>
